...
namespace PolarPet
{
    ...
    public sealed class SoapItem : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        ...
        [Header("AI Integrate")]
        [Tooltip("可選：若有掛 PetAiController，搓澡期間會暫停 AI 自動行為。")]
        ...
        private void StartBathing(Animator petAnimator)
        {
            ...
            if (petAiController == null && currentPetAnimator != null)
            {
                petAiController = currentPetAnimator.GetComponentInParent<PetAiController>();
            }
            if (petAiController != null)
            {
